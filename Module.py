...
class SIM(nn.Module):
    def __init__(self, h_C, l_C):
        ...
        self.h2h_2 = nn.Conv2d(h_C, l_C, 3, 1, 1)
        self.l2h_2 = nn.Conv2d(l_C, l_C, 3, 1, 1)
        self.bnh_2 = nn.BatchNorm2d(l_C)
    ...
    def forward(self, x):
        ...
        # x_l = self.relu(self.bnl_0(self.h2l_0(y)))
...
class AIM(nn.Module):
    ...
    def forward(self, *xs):
        # in_data_2, in_data_4, in_data_8, in_data_16
        out_xs = []
